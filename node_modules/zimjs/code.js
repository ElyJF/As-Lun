...
// Welcome to ZIM at https://zimjs.com - JavaScript Canvas Framework - Code Creativity!
// ZIM adds many conveniences, components and controls to CreateJS https://createjs.com
// Founded by Inventor Dan Zen - http://danzen.com - Canadian New Media Award Winner
// ZIM is free to use. You can donate to help improve ZIM at https://zimjs.com/donate

// REFERENCES
// https://dev.zimjs.com
// https://zimjs.com/tips.html       https://zimjs.com/docs.html
// https://zimjs.com/learn.html      https://zimjs.com/about.html
// https://zimjs.com/examples.html   https://zimjs.com/code.html

require('@danzen/createjs');
const makeZIM = require('zimjs');
const zim = makeZIM(); // pass in true to use zim namespace **
const [zog,zid,zss,zgo,zum,zot,zop,zil,zet,zob,zik,zta,zor,zogr,zogb,zogg,zogo,zogp,zogy,zogd,zogl] = zim.getGlobals();
